...
nmap  ' :norm bi'ea'
nmap  " :norm bi"ea"
nnoremap  <F8> :vs ~/.vim/ftplugin/%:e.vim
noremap Q gq
nnoremap YY ZZ
nnoremap YQ ZQ
...
nnoremap <C-N> =
nnoremap <C-M> |_
nnoremap <F8> :e ~/.vim/ftplugin/%:e.vim
...
set lazyredraw
set ruler
set runtimepath=~/.vim,~/.vim/plugged/sonokai,~/.vim/plugged/ctrlp.vim,~/.vim/plugged/coc.nvim,~/.vim/plugged/tex-conceal.vim,~/.vim/plugged/ultisnips,~/.vim/plugged/vimwiki,/usr/share/vim/vimfiles,/usr/share/vim/vim82,/usr/share/vim/vimfiles/after,~/.vim/plugged/tex-conceal.vim/after,~/.vim/plugged/ultisnips/after,~/.vim/after
set shiftwidth=4
set smartcase
set softtabstop=4
set splitbelow
...
wincmd w
argglobal
if bufexists("Quest.py") | buffer Quest.py | else | edit Quest.py | endif
balt build.py
setlocal keymap=
setlocal noarabic
setlocal autoindent
